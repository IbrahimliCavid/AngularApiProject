...
namespace Persistence.Migrations
{
    ...
    [Migration("20250311103909_Mig_13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entites.Basket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entites.BasketItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entites.Basket", b =>
                {
                    b.HasOne("Domain.Entites.Identity.AppUser", "User")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("Domain.Entites.BasketItem", b =>
                {
                    b.HasOne("Domain.Entites.Basket", "Basket")
            ...
            modelBuilder.Entity("Domain.Entites.Order", b =>
                {
                    ...
                    b.HasOne("Domain.Entites.Basket", "Basket")
                        .WithOne("Order")
                        .HasForeignKey("Domain.Entites.Order", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    b.HasOne("Domain.Entites.ProductImageFile", null)
                        .WithMany()
